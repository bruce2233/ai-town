...
async function main() {
    ...
    const geppetto = new Agent("Geppetto", "You are an expert character designer. You create detailed, unique personas for new AI agents. When you receive a request on 'town:create_character', you reply *only* with a valid JSON object describing the new agent, like {\"name\": \"name\", \"persona\": \"persona\"}. Do not include any other text.");
